...
<body>
	...
	maps that you can create and share with other players and this is where first encountered a very basic form of programming. Although 
	the programming part was very simple, there was a list of premade triggers and each one was selected. Each
	...
	<p class="first"> This website was created to display up to date information about myself, and to list all
	of my applicable skills on projects. On the left side is a navigation bar, this page is About. The projects
	page will contain all of my projects. Skills will contain a look at all of my skills, while the Resume link
	contains my resume. The goal of the skills page is to have a more elaborate defintion of my skills than what 
	my resume contains. Contact contains basic contact information. This is currently version 1 of the website,
	with no formal training in HTML or CSS. In the Fall 2016 I am taking a class on web programming and hopefully
	I will learn more about HTML, CSS, PHP, Javascript, and whatever other tools I might need. Future iterations of
	this website may use Bootstrap or another tool to make it more appealing. 
	</p>
